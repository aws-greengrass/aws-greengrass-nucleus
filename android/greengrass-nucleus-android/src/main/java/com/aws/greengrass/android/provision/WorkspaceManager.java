...
public final class WorkspaceManager {
    ...
    private static final ConcurrentHashMap<File, WorkspaceManager> workspaceManagerMap = new ConcurrentHashMap<>();
    ...
    private WorkspaceManager(@NonNull File filesDir) {
        ...
        // FIXME: it is process global setting
     ...
     */
    public static WorkspaceManager getInstance(@NonNull File filesDir) {
        return workspaceManagerMap.computeIfAbsent(filesDir, c -> new WorkspaceManager(filesDir));
    }
