Feature: Testing Cloud component in Greengrass
  ...
  Scenario: As a developer, I can create a component in Cloud and deploy it on my device
    When I create a Greengrass deployment with components
      | com.aws.HelloWorld | file:src/main/resources/greengrass/recipes/recipe.yaml |
    ...
    When I create a Greengrass deployment with components
      | com.aws.HelloWorld | file:src/main/resources/greengrass/recipes/updated_recipe.yaml |
    And I deploy the Greengrass deployment configuration
    Then the Greengrass deployment is COMPLETED on the device after 180 seconds
