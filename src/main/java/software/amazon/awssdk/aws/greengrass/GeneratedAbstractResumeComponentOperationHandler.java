...
public abstract class GeneratedAbstractResumeComponentOperationHandler
        extends
            OperationContinuationHandler<ResumeComponentRequest, ResumeComponentResponse, EventStreamJsonMessage, EventStreamJsonMessage> {
    protected GeneratedAbstractResumeComponentOperationHandler(OperationContinuationHandlerContext context) {
        super(context);
    }
