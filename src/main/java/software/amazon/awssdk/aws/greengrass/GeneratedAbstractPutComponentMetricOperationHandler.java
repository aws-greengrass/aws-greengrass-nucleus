...
public abstract class GeneratedAbstractPutComponentMetricOperationHandler
        extends
            OperationContinuationHandler<PutComponentMetricRequest, PutComponentMetricResponse, EventStreamJsonMessage, EventStreamJsonMessage> {
    protected GeneratedAbstractPutComponentMetricOperationHandler(OperationContinuationHandlerContext context) {
        super(context);
    }
