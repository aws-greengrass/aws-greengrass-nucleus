...
public abstract class GeneratedAbstractCancelLocalDeploymentOperationHandler
        extends
            OperationContinuationHandler<CancelLocalDeploymentRequest, CancelLocalDeploymentResponse, EventStreamJsonMessage, EventStreamJsonMessage> {
