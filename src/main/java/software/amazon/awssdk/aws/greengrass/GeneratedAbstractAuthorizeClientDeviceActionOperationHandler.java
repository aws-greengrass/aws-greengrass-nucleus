...
public abstract class GeneratedAbstractAuthorizeClientDeviceActionOperationHandler
        extends
            OperationContinuationHandler<AuthorizeClientDeviceActionRequest, AuthorizeClientDeviceActionResponse, EventStreamJsonMessage, EventStreamJsonMessage> {
