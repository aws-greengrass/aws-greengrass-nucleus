...
public abstract class GeneratedAbstractPauseComponentOperationHandler
        extends
            OperationContinuationHandler<PauseComponentRequest, PauseComponentResponse, EventStreamJsonMessage, EventStreamJsonMessage> {
    protected GeneratedAbstractPauseComponentOperationHandler(OperationContinuationHandlerContext context) {
        super(context);
    }
