...
public enum DeploymentErrorCode {
    ...
    CLOUD_SERVICE_ERROR(DeploymentErrorType.NONE),
    ...
    DOCKER_ARTIFACT_URI_NOT_VALID(DeploymentErrorType.REQUEST_ERROR),
    ...
    S3_ACCESS_DENIED(DeploymentErrorType.DEPENDENCY_ERROR),
    S3_BAD_REQUEST(DeploymentErrorType.DEPENDENCY_ERROR),
    S3_SERVER_ERROR(DeploymentErrorType.DEPENDENCY_ERROR),
    ...
    // Component issues
    COMPONENT_VERSION_REQUIREMENTS_NOT_MET(DeploymentErrorType.COMPONENT_ERROR),
