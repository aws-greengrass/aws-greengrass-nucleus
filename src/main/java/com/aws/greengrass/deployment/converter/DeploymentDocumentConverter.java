...
public final class DeploymentDocumentConverter {
    ...
    public static DeploymentDocument convertFromLocalOverrideRequestAndRoot(LocalOverrideRequest localOverrideRequest,
        ...
        return DeploymentDocument.builder()
                .timestamp(localOverrideRequest.getRequestTimestamp())
                ...
                .failureHandlingPolicy(
                        convertFailureHandlingPolicyFromSDK(localOverrideRequest.getFailureHandlingPolicy()))
                ...
                .configurationValidationPolicy(DeploymentConfigurationValidationPolicy.builder()
                        .timeoutInSeconds(DEFAULT_TIMEOUT_SECOND)
                        .build())
                .componentUpdatePolicy(new ComponentUpdatePolicy(NO_OP_TIMEOUT, SKIP_NOTIFY_COMPONENTS))
                .groupName(StringUtils.isEmpty(localOverrideRequest.getGroupName())
    ...
    private static List<DeploymentPackageConfiguration> buildDeploymentPackageConfigurations(
        ...
        if (localOverrideRequest.getComponentToRunWithInfo() != null) {
            localOverrideRequest.getComponentToRunWithInfo().forEach((componentName, runWithInfo) -> {
                if (runWithInfo != null) {
                    packageConfigurations.computeIfAbsent(componentName, DeploymentPackageConfiguration::new);
                    RunWith runWith = RunWith.builder()
                            .posixUser(runWithInfo.getPosixUser())
     ...
     *
     * @param config Fleet configuration that is generated by CreateDeployment and gets sent down via IoT Job and shadow
    ...
    public static DeploymentDocument convertFromDeploymentConfiguration(Configuration config)
        ...
        DeploymentDocument.DeploymentDocumentBuilder builder = DeploymentDocument.builder()
                .configurationArn(config.getConfigurationArn())
        ...
        if (config.getFailureHandlingPolicy() == null) {
            ...
            logger.atWarn()
                    .log("FailureHandlingPolicy should be provided but is not provided. "
        ...
        if (config.getComponentUpdatePolicy() == null) {
            ...
            // However if it is not, device could proceed with default for resilience.
            logger.atWarn()
                    .log("ComponentUpdatePolicy should be provided but is not provided. "
                            + "Proceeding with default failure handling policy.");
        } else {
        ...
        if (config.getConfigurationValidationPolicy() == null) {
            ...
            // However if it is not, device could proceed with default for resilience.
            logger.atWarn()
                    .log("ConfigurationValidationPolicy should be provided but is not provided. "
                            + "Proceeding with default failure handling policy.");
        } else {
            builder.configurationValidationPolicy(
                    convertConfigurationValidationPolicy(config.getConfigurationValidationPolicy()));
        }
    ...
    private static DeploymentPackageConfiguration convertComponent(String componentName,
        ...
        DeploymentPackageConfiguration.DeploymentPackageConfigurationBuilder builder =
                DeploymentPackageConfiguration.builder()
                        ...
                        .rootComponent(true) // As of now,
                        // CreateDeployment API only gives root component
        ...
        builder = builder.runWith(RunWith.builder()
                ...
                .systemResourceLimits(componentUpdate.getRunWith() == null
                        ? null
    ...
    private static DeploymentConfigurationValidationPolicy convertConfigurationValidationPolicy(
            @Nonnull com.amazon.aws.iot.greengrass.configuration.common.ConfigurationValidationPolicy configurationValidationPolicy) {
