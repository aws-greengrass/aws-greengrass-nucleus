 ...
 * </pre>
 */
public abstract class ExecBase implements Closeable {
    private static final char PATH_SEP = File.pathSeparatorChar;
    private static final Logger staticLogger = LogManager.getLogger(ExecBase.class);
    ...
    public ExecBase setenv(String key, CharSequence value) {
        environment.put(key, value instanceof String ? (String) value : Coerce.toString(value));
        return this;
    }

    public ExecBase logger(Logger logger) {
        this.logger = logger;
        return this;
    }
    ...
    public ExecBase cd(String d) {
        return cd(dir.toPath().toAbsolutePath().resolve(Paths.get(d)).toAbsolutePath().toFile());
    }

    /**
     * Get the working directory which is configured for the ExecBase.
     *
     ...
     * @return this.
     */
    public ExecBase withExec(String... c) {
        cmds = c;
        return this;
    }
     ...
     * @return this.
     */
    public ExecBase withShell(String... command) {
        withShell();
     ...
     * @return this.
     */
    public ExecBase usingShell(String shell) {
     ...
     * @return this.
     */
    public ExecBase withUser(String user) {
     ...
     * @return this.
     */
    public ExecBase withGroup(String group) {
        if (userDecorator == null) {
            userDecorator = Platform.getInstance().getUserDecorator();
        }
     ...
     * @return this.
     */
    public ExecBase withTimeout(long t, TimeUnit u) {
        timeout = t;
        timeunit = u;
        return this;
    }
    ...
    public ExecBase withDumpOut() {
        return withOut(l -> System.out.println("stderr: " + l)).withErr(l -> System.out.println("stdout: " + l));
    }

    public ExecBase withOut(Consumer<CharSequence> o) {
        stdout = o;
        return this;
    }

    public ExecBase withErr(Consumer<CharSequence> o) {
        stderr = o;
        return this;
    }
