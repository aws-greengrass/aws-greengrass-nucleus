...
public class LLTest {
    ...
    public void T1() {
        ...
        assertEquals(50+3/60.+59/60./60.,p1.lat,1e-8, "lat");
        assertEquals(-(5+42/60.+53/60./60.),p1.lon,1e-8, "lon");
        LL p2=new LL("58 38 38N,003 04 12W");
        assertEquals(968.9e3,p1.distanceM(p2),2e2, "distance");
        assertEquals(968.9e3,p2.distanceM(p1),2e2, "distance");
        assertEquals(LL.parseAngle("009° 07′ 11″"), p1.bearingTo(p2),1e-3, "bearingTo ");
    }
