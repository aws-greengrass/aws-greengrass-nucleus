...
class PackageRegistryEntryTest {
    ...
    void GIVEN_package_registry_entry_WHEN_equality_is_called_THEN_decide_if_they_are_equal() {
        PackageRegistryEntry entry1 = new PackageRegistryEntry("A", new Semver("1.2.3"),
                Collections.singletonMap("P", new PackageRegistryEntry.Reference("P", new Semver("1.4.5"), ">=1.0.0")));
