...
class RecipeLoaderTest {
    ...
    @Test
    void GIVEN_a_recipe_yaml_file_with_all_fields_and_mocked_resolved_platform_WHEN_converts_THEN_fields_are_populated_correctly()
            throws Exception {
    ...
    @Test
    void GIVEN_a_recipe_json_file_with_all_fields_and_mocked_resolved_platform_WHEN_converts_THEN_fields_are_populated_correctly()
            throws Exception {

        // GIVEN
        // read file
        String filename = "sample_recipe_with_all_fields.json";
        String recipeFileContent = new String(Files.readAllBytes(Paths.get(getClass().getResource(filename).toURI())));
