...
class PlatformResolverTest {
    ...
    void WHEN_config_contains_nulls_THEN_nulls_handled_sanely() throws Exception {
        ...
        assertThat(PlatformResolver
                .filterPlatform(nested, new HashSet<>(Arrays.asList("subKey3", "subKey4")), Arrays.asList("subKey3"))
                .orElse("none"), equalTo("none"));
        assertThat(PlatformResolver
                .filterPlatform(nested, new HashSet<>(Arrays.asList("subKey3", "subKey4")), Arrays.asList("subKey4"))
                .orElse("bad"), equalTo("val4"));
        Object o = PlatformResolver
                .filterPlatform(data, new HashSet<String>(Arrays.asList("key1", "key2")), Arrays.asList("key2"))
                .orElse("bad");
