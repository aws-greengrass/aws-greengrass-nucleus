...
//    @Test
    ...
    private String sendCreateDeploymentRequest(String targetThingGroupArn, DeploymentDocument document) throws IOException {
        // construct http request
        HttpPost request = new HttpPost(CLOUD_SERVICE_URL);
        request.setHeader(HTTP_HEADER_ETAG, UUID.randomUUID().toString());

        String body = mapper
                .writeValueAsString(new DeploymentRequest(targetThingGroupArn, "Thing deployment", document, null));
